                        ...
                        <tbody>
                            <template v-for="(value, index) in list" :key="index">
                                ...
                                <td class="align-middle text-center">
                                    <button v-if="value.tinh_trang==1" class="btn btn-success btn-sm">Hoạt Động</button>
                                    <button v-else class="btn btn-warning text-light btn-sm">Tạm Khóa</button>
                                </td>
                                <td class="text-center align-middle" style="width: 20%;">
                                    <button v-on:click="Object.assign(edit, value)" class="btn btn-sm btn-primary me-2"
                                        data-bs-toggle="modal" data-bs-target="#updateNhanVien"><i
...
<div class="modal fade" id="addNhanVien" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" class="form-control mt-2 mb-2" placeholder="Số Điện Thoại" aria-label="First name">
        <label for="">Mật Khẩu</label>
        <input type="password" class="form-control mt-2 mb-2" placeholder="Mật Khẩu" aria-label="First name">
...
<!--Cập Nhật Modal -->
<div class="modal fade" id="updateNhanVien" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
...
<!--Xóa Modal -->
<div class="modal fade" id="delNhanVien" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
