        ...
        <div class="col-lg-7" style="padding: 0;">
            ...
            <div style="padding: 15px; border-top: 1px solid #dee2e6;">
                <div style="display: flex; justify-content: flex-end; align-items: center;">
                    ...
                    <h5 style="font-weight: 600; color: #dc3545; margin: 0; font-size: 1.2rem;">{{ formatVND(thanh_tien)
                    }}</h5>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        xacNhanDatHang() {
            ...
            axios
                .post('http://127.0.0.1:8000/api/khach-hang/xac-nhan-dat-hang', this.xac_nhan_dat_hang, {
                    headers: {
